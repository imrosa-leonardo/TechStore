...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-950 pattern-bg">
      ...
      <div className="w-[450px] bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden">
        ...
        <div className="p-10 space-y-8">
          <div className="space-y-2 text-center">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Bem-vindo de volta</h2>
            <p className="text-gray-600 dark:text-gray-400">Digite seus dados para acessar o sistema.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Campo Usuário */}
            <div className="space-y-2">
              <label htmlFor="username" className="text-gray-700 dark:text-gray-300 font-medium block">Nome do Usuário</label>
            ...
            <div className="space-y-2 relative">
              <label htmlFor="password" className="text-gray-700 dark:text-gray-300 font-medium block">Senha</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
               ...
               <a href="#" className="text-blue-600 dark:text-blue-400 text-sm font-medium absolute right-0 -bottom-6">Esqueceu a senha?</a>
            </div>
            ...
            <div className="pt-6">
              <button
                type="submit"
                className="w-full bg-blue-600 text-white p-4 rounded-lg text-xl font-bold hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900/40 transition-all"
              >
                Acessar Sistema
              </button>
            </div>
          ...
          <div className="pt-6 border-t border-gray-100 dark:border-gray-700 text-center space-y-4">
            <p className="text-gray-600 dark:text-gray-400">
              Não tem uma conta? <Link to="/registrar" className="text-blue-600 dark:text-blue-400 font-medium">Cadastre-se</Link>
            </p>
            <p className="text-gray-600 dark:text-gray-400">
              Precisa de ajuda? <a href="#" className="text-blue-600 dark:text-blue-400 font-medium">Suporte</a>
            </p>
            <p className="text-[11px] text-gray-400 dark:text-gray-500 pt-2">TechStore Info/Company</p>
          </div>
        </div>
      </div>
    </div>
